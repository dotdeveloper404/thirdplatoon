<template>
    <app-layout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Job</h2>
        </template>
        <div class="py-12">
                        ...
                        <div class="mb-5">
                            <div class="flex flex-wrap">
                                ...
                                <div class="w-2/12 pr-3">
                                    <div class="mb-4">
                                        <label class="text-gray-700 text-lg font-bold flex items-center p-4 max-w-xs mx-auto bg-white border rounded bg-gray-100">
                                            <input type="checkbox" id="urgent" class="h-5 w-5 mr-2" v-model="form.urgent" :checked="form.urgent">
                                            <span>Urgent</span>
                                        </label>
                                ...
                                <div class="w-2/12 pr-3">
                                    <div class="mb-4">
                                        <label class="text-gray-700 text-lg font-bold flex items-center p-4 max-w-xs mx-auto bg-white border rounded bg-gray-100">
                                            <input type="checkbox" id="featured" class="h-5 w-5 mr-2" v-model="form.featured" :checked="form.featured">
                                            <span>Featured</span>
                                        </label>
...
export default {
    ...
    props: ["job", "categories", "currencies", "errors"],
    ...
    data() {
        return {
            ...
            form: {
                ...
                pay_start: this.job.pay_start,
                pay_end: this.job.pay_end,
                pay_type: this.job.pay_type,
                description: this.job.description,
                allownces: this.job.allownces,
                requirements: this.job.requirements,
                valid_till: this.job.valid_till_format,
    ...
    methods: {
        update() {
            ...
            this.$inertia.post(this.job.update_url, fd, {
                headers: {
