<template>
    <div>
        <div class="p-6 sm:px-20 bg-white border-b border-white-200">
            ...
            <div class="mt-6 text-white-500"></div>
        </div>
        ...
        <!-- <div class="bg-white-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div
                        class="ml-4 text-lg text-white-600 leading-7 font-semibold"
                    >
            ...
            <div
                class="p-6 border-t border-white-200 md:border-t-0 md:border-l"
            >
                <div class="flex items-center">
                    <svg
                        fill="none"
            ...
            <div class="p-6 border-t border-white-200">
                <div class="flex items-center">
                    <svg
                        fill="none"
                        stroke="currentColor"
            ...
            <div class="p-6 border-t border-white-200 md:border-l">
                <div class="flex items-center">
                    <svg
                        fill="none"
                        stroke="currentColor"
